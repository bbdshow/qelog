...
//func (svc *Service) MetricsDBStats(ctx context.Context, out *entity.ListResp) error {
//	// 先查看最后一条， 如果超时就去库里查询
...
//	mainStats, err := svc.readDBStatsAndInsert(ctx, mainCfg.URI, mainHost, mainCfg.DataBase)
//	if err != nil {
...
//		sStats, err := svc.readDBStatsAndInsert(ctx, v.URI, host, v.DataBase)
//		if err != nil {
//			return httputil.ErrSystemException.MergeError(err)
//		}
//
...
//}
//
//func (svc *Service) MetricsCollStats(ctx context.Context, in *entity.MetricsCollStatsReq, out *entity.ListResp) error {
//	uri := ""
//	mainCfg := model.ShardingDB.MainConfig()
//	shardingCfg := model.ShardingDB.ShardSlotsConfig()
//
...
//	}
//	collStats, err := svc.readCollStatsAndInsert(ctx, uri, in.Host, in.DBName)
//	if err != nil {
//		return err
//	}
//
...
//}
//
//func (svc *Service) MetricsModuleList(ctx context.Context, in *entity.MetricsModuleListReq, out *entity.ListResp) error {
...
//	c, docs, err := svc.moduleMetricsStore.FindCountModuleMetrics(ctx, filter, opt)
//	if err != nil {
//		return httputil.ErrSystemException.MergeError(err)
//	}
//	out.Count = c
...
//}
//
//func (svc *Service) MetricsModuleTrend(ctx context.Context, in *entity.MetricsModuleTrendReq, out *entity.MetricsModuleTrendResp) error {
//	now := time.Now()
...
//	}
//
//	_, docs, err := svc.moduleMetricsStore.FindCountModuleMetrics(ctx, filter, nil)
//	if err != nil {
//		return httputil.ErrSystemException.MergeError(err)
//	}
//
...
//}
//
//func (svc *Service) readDBStatsAndInsert(ctx context.Context, uri, host, database string) (*model.DBStats, error) {
//	filter := bson.M{
//		"host":       host,
//		"db":         database,
...
//	ok, err := svc.moduleMetricsStore.FindOneDBStats(ctx, filter, latestDBStats, opt)
//	if err != nil {
//		return nil, err
//	}
//	if ok {
...
//	}
//
//	_ = svc.moduleMetricsStore.InsertOneDBStats(ctx, doc)
//
//	return doc, nil
//}
//
//func (svc *Service) readCollStatsAndInsert(ctx context.Context, uri, host, database string) ([]*model.CollStats, error) {
//	filter := bson.M{
//		"host":       host,
//		"db":         database,
...
//	latestCollStats, err := svc.moduleMetricsStore.FindCollStats(ctx, filter, opt)
//	if err != nil {
//		return nil, err
//	}
//
...
//	}
//
//	_ = svc.moduleMetricsStore.InsertManyCollStats(ctx, insertDocs)
//
//	return latestCollStats, nil
//}
