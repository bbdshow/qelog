...
//)
//
//func (svc *Service) FindLoggingByTraceID(ctx context.Context, in *entity.FindLoggingByTraceIDReq, out *entity.ListResp) error {
...
//		}
//	} else {
//		collectionNames = append(collectionNames, svc.sc.ScopeCollectionNames(in.ShardingIndex, b.Unix(), e.Unix())...)
//	}
//	count := int64(0)
...
//}
//
//func (svc *Service) FindLoggingList(ctx context.Context, in *entity.FindLoggingListReq, out *entity.ListResp) error {
//
//	s := time.Now()
...
//	} else {
//		// 计算集合名
//		names := svc.sc.ScopeCollectionNames(in.ShardingIndex, b.Unix(), e.Unix())
//		if len(names) >= 2 {
//			format := "2006-01-02 15:04:05"
//			suggestTime, _ := svc.sc.SuggestSpanTime(names[0])
...
//}
//
//func (svc *Service) DropLoggingCollection(ctx context.Context, in *entity.DropLoggingCollectionReq) error {
//	//  先检查 collectionName
...
//// 月为单位
//func (svc *Service) backgroundDelExpiredCollection(maxAgeMonth int) {
//	if maxAgeMonth <= 0 {
//		// 永久保存
//		return
//	}
...
//			// 判断是否过期
//			for _, v := range names {
//				date, err := svc.sc.CollectionNameToTime(v)
//				if err != nil {
